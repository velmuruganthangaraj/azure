                ...
                if (response.status == true) {
                    ...
                    if (response.data.length === 0) {
                        ...
                        for (var i = 0; i < response.data.length; i++) {
                            users += "<li>";
                            users += "<a href='" + viewUserProfileUrl + "?username=" + response.data[i].UserName + "'>";
                            users += "<img width='32' height='32' src='" + getUserAvatarUrl + "?ImageSize=64&Username=" +
