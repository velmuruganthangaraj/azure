...
function onAddApplicationDialogOpen() {
    ...
    $(".head-icon").removeClass("su-edit-app");
    $(".head-icon").addClass("su-add-app");
    ...
    $("#icon-img").attr("src", getDefaultApplicationLogoUrl + "?applicationtype=1");
    urlCount = 1;
    urlboxes = [1];
    isAppDialog = true;
}
...
function onEditApplicationDialogOpen() {
    ...
    urlboxes = [1];
    $("#application-dialog").ejDialog("open");
    $(".head-icon").removeClass("su-add-app");
    $(".head-icon").addClass("su-edit-app");
    ...
    if (selectedRowData.data.Icon.toLocaleLowerCase() == "na") {
        $("#icon-img").attr("src", getDefaultApplicationLogoUrl + "?applicationtype=" + selectedRowData.data.ApplicationTypeId);
    } else {
        $("#icon-img").attr("src", getApplicationLogoUrl + "?id=" + selectedRowData.data.ClientId);
    }
...
function setDefaultIcon() {
    ...
    $("#icon-img").attr("src", getDefaultApplicationLogoUrl + "?applicationtype=" + checkedVal);
}
