...
ALTER TABLE SfUMS_ADCredential ADD ActiveDirectoryNewUserLogin smallint NOT NULL default 0
;

ALTER TABLE SfUMS_AzureADCredential ADD NewUserLogin smallint NOT NULL default 0
;

ALTER TABLE SfUMS_SAMLSettings ADD MobileAppId varchar(100)
;

ALTER TABLE SfUMS_User ALTER COLUMN Contact TYPE varchar(64)
;

ALTER TABLE SfUMS_AppAccessToGroups ALTER COLUMN CreatedById TYPE int
;

ALTER TABLE SfUMS_AppAccessToGroups ALTER COLUMN ModifiedById TYPE int
;
